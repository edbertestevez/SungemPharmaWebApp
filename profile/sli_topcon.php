...
<div class="card-wrapper profile-right-main-cont">
    ...
    <div class="card-content">
      <h3 style="width: 100%; margin: 20px 0px 8px 10px;float: left;">Top 5 Consignment</h3>
      <h5 style="margin-left: 10px;">Your top 5 list of most consigned medicine</h5>
      ...
      <?php
      $ret = $user->get_top_consigned($_SESSION['clientid']);
      foreach($ret as $data){
      ?>
        <tr class="no-hover">
