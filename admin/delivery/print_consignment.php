...
function Header()
{
    ...
    $this->Cell(240,10,'CONSIGNMENT',0,0,'C');
    ...
    $delivery = new Delivery();
    $selected = $delivery->get_selected_delivery($_GET['delivery_id']);
    $this->Cell(45,7,$selected['order_id'],1,0,'C');
    ...
    $this->Ln(6);
    $this->Cell(2);
    $this->Cell(105,10,$selected['client_name'],1,1,'L');
    $this->Ln(-10);
    $this->Cell(117);
    $this->Cell(35,10,'Consignment',1,0,'L');
    $this->Cell(35,10,$selected['mr_lastname'],1,0,'L');
...
function Footer()
{
    ...
    $this->Cell(185,10,'*** NOTE: FIRST IN FIRST OUT ***',0,0,'C');
    $this->ln(10);
    $this->Cell(2);
    $this->SetFont('Times','B',9);
    $this->Cell(120,5,'*** NOTE: FIRST IN FIRST OUT ***',1,0,'C');
    $this->Cell(65,5,'TOTAL AMOUNT',1,0,'C');
    $this->ln(5);
    $this->Cell(2);
    $this->SetFont('Times','BI',11);
    $this->Cell(120,15,'Please arrange newer batch under or behind previous batch',0,0,'C');
